    ...
    <div class="container container-main">
        <div class="content content-1">
            ...
            <div class="container-data">
                <div class="content-data content-data-1">
                    <div class="content-data-icon content-data-icon-1">
                        <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" fill="currentColor"
                            class="bi bi-telephone icon-svg" viewBox="0 0 16 16">
                            <path
                    ...
                    <h4 class="data-subtitle">
                        21 3435-3534
                    </h4>
                </div>
                <div class="content-data">
                    <div class="content-data-icon">
                        <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" fill="currentColor"
                            class="bi bi-whatsapp icon-svg" viewBox="0 0 16 16">
                            <path
                ...
                <div class="content-data content-data-6">
                    <div class="content-data-icon content-data-icon-6">
                        <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" fill="currentColor"
                            class="bi bi-geo-alt icon-svg" viewBox="0 0 16 16">
                            <path
